// Cross-sectional report builder implementation (plan §3 Step C).
...
import { type BuildReportConfig, createEmptyRegimeBreakdown } from './report.config';
...
export function buildCrossSectionalReport(
  ...
  // Regime breakdown
  let byRegime = createEmptyRegimeBreakdown();
